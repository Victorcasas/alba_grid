...
public class OpenCobolInputServiceParser extends DefaultInputServiceParser {

	private static GridLog logger = GridLogFactory.getInstance().getLog(OpenCobolInputServiceParser.class);
