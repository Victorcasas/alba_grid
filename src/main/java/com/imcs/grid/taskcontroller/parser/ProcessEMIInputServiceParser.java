...
public class ProcessEMIInputServiceParser extends DefaultInputServiceParser {

	private static GridLog logger = GridLogFactory.getInstance().getLog(ProcessEMIInputServiceParser.class);
	...
	public Request parse(Object[] inputs) throws TaskcontrollerParserException {
		...
		for (Object obj : inputs) {
			if (obj instanceof OMElement) {
				ome = (OMElement)obj;
				DefaultParam[] parameter = parserExecuteProcessEMIMessage(ome);
				Object value = null;
	...
	public DefaultParam[] parserExecuteProcessEMIMessage(OMElement ome) throws TaskcontrollerParserException {
