...
public class CompileCobolInputServiceParser extends DefaultInputServiceParser {

	private static GridLog logger = GridLogFactory.getInstance().getLog(CompileCobolInputServiceParser.class);
