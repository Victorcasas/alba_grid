...
public class GetParalleActiveJobsParser extends DefaultInputServiceParser {
	
private static GridLog logger = GridLogFactory.getInstance().getLog(GetParalleActiveJobsParser.class);
	...
	public OMElement responseParse(Response input) throws TaskControllerException {	
		...
		gridJobResponseElto.addAttribute("fileReference",(String)input.get("mdsReference"),ns);
