...
public class Linpack {
	...
	private static GridLog logger = GridLogFactory.getInstance().getLog(Linpack.class);
	...
	public double[] run_benchmark() 
	{
		...
		logger.debug("Mflops/s: " + mflops_result +
				"  Time: " + time_result + " secs" +
				"  Norm Res: " + residn_result +
				"  Precision: " + eps_result);
		
		return new double[] {mflops_result,time_result, residn_result, eps_result };
	}
	...
	/*
	 ...
	 on entry a double precision[n][lda] the output from dgeco or dgefa.
